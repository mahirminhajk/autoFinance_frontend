...
import { Button, Checkbox, Dialog, DialogBody, DialogHeader, Input } from '@material-tailwind/react';
import axiosapi from '../../helpers/axiosapi';
function DocUpdateChild({
    docData,
    setDocData,
    setDocStatus,
    cusId,
    ...
    const setUpdateAvailableTrue = () => {
        if (!updateAvailable) setUpdateAvailable(true);
    }

    const handleFileChange = (e, field) => {
        setUpdateAvailableTrue();
    ...
    const handleUpdate = () => {
        ...
        try {
            axiosapi
                .patch(`/cus/doc/${cusId}/?docname=${docData.docname}`, formData)
                .then((res) => {
                        ...
                        <div className="relative">
                            <div className="grid grid-cols md:grid-cols-2 lg:grid-cols-2">
                                <div className="grid grid-cols lg:grid-rows-2 gap-2 mx-10">
                                    ...
                                    {!singleImg && imgSrc.img2 && imgSrc.img2 !== "false" ? (
                                        <div>
