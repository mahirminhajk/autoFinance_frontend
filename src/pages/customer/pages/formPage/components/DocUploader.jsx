...
function DocUploader({ docObj, cusId, docname, setDocsArray, setDocs }) {
  ...
  const [verifyData, setVerifyData] = useState(docObj.verifydoc);
    ...
    try {
      axiosapi
        ...
        .then((res) => {
          ...
          setVerifyData(docObj.verifydoc);
          handleOpen();
        });
    } catch (error) {
      setErr(
  ...
  return (
    <Fragment>
      ...
      <Dialog open={open} handler={handleOpen} size="lg">
        <DialogHeader>{`Upload ${docname}`}</DialogHeader>
        <DialogBody>
